...
variable "vpc_id" {
  type        = string
  description = "VPC id to be used for creating resources"
}

variable "ssm_name" {
  description = "Name of SSM parameter that holds the password"
  type        = string
  default     = ""
}

variable "source_security_group_rule" {
  description = "Rule used for source security group."
  type        = string
  default     = ""
}
