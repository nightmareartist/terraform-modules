variable "rules" {
  ...
  default = {
    # Allow all TCP, should be used for testing purposes only!
    allow-all-tcp = [0, 65535, "tcp", "Allow all TCP"]
    # ActiveMQ
    ...
    kafka-broker-sasl-tcp = [9096, 9096, "tcp", "Kafka SASL enabled broker"]
    kafka-zookeeper-tcp   = [2181, 2181, "tcp", "Kafka Zookeeper"]
    # LDAPS
