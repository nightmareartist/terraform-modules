...
resource "aws_security_group_rule" "ingress_with_source_security_group_id" {
  ...
  # This is a fix so that multiple security_group_ids can be used in a single configuration
  security_group_id = var.create_group ? local.this_sg_id : var.ingress_with_source_security_group_id[count.index]["source_security_group"]
  type              = "ingress"
...
resource "aws_security_group_rule" "egress_with_source_security_group_id" {
  ...
  # This is a fix so that multiple security_group_ids can be used in a single configuration
  security_group_id = var.create_group ? local.this_sg_id : var.egress_with_source_security_group_id[count.index]["source_security_group"]
  type              = "egress"
